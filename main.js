...
/* harmony import */ var fidj__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! fidj */ "./node_modules/fidj/fesm5/fidj.js");
/* harmony import */ var _shared_profile_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/profile.service */ "./src/app/shared/profile.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, fidjService, router, network, profile) {
    ...
    AppComponent.prototype.initFidj = function () {
        var _this = this;
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            ...
            fidj__WEBPACK_IMPORTED_MODULE_6__["FidjService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"],
            _ionic_native_network_ngx__WEBPACK_IMPORTED_MODULE_5__["Network"],
            _shared_profile_service__WEBPACK_IMPORTED_MODULE_7__["Profile"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var fidj__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! fidj */ "./node_modules/fidj/fesm5/fidj.js");



var AuthGuard = /** @class */ (function () {
    function AuthGuard(fidjService) {
        this.fidjService = fidjService;
    }
    ...
    AuthGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [fidj__WEBPACK_IMPORTED_MODULE_2__["FidjService"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
/***/ "./src/app/shared/fidj-storage.model.ts":
/*!**********************************************!*\
  !*** ./src/app/shared/fidj-storage.model.ts ***!
  \**********************************************/
/*! exports provided: RadarNode, RainNode, PeopleNode, EventNode, FidjStorageNode, FidjStorage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RadarNode", function() { return RadarNode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RainNode", function() { return RainNode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PeopleNode", function() { return PeopleNode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventNode", function() { return EventNode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FidjStorageNode", function() { return FidjStorageNode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FidjStorage", function() { return FidjStorage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

var RadarNode = /** @class */ (function () {
    function RadarNode() {
    }
    return RadarNode;
}());

var RainNode = /** @class */ (function () {
    function RainNode() {
    }
    return RainNode;
}());

var PeopleNode = /** @class */ (function () {
    function PeopleNode() {
    }
    return PeopleNode;
}());
...
var FidjStorageNode = /** @class */ (function () {
    function FidjStorageNode() {
        this.radars = [];
        this.rains = [];
        this.team = [];
        this.events = [];
    }
    FidjStorageNode.getEmptyNode = function () {
        return new FidjStorageNode();
    };
    FidjStorageNode.getDemoNode = function () {
        var demoNode = new FidjStorageNode();
        demoNode.radars = [
            {
                id: 'dr1',
                name: 'demo radar A',
    ...
    return FidjStorageNode;
}());

var FidjStorage = /** @class */ (function () {
    function FidjStorage() {
        this.node = FidjStorageNode.getEmptyNode();
        this.fidjMetaResult = { data: {} };
    }
    FidjStorage.prototype.set = function (fidjService) {
        this.fidjMetaResult.data = this.node;
        fidjService.put(this.fidjMetaResult);
    };
    FidjStorage.prototype.getRefreshedNode = function (fidjService) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var firstDemoData, fidjFindAllResults;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        firstDemoData = function () {
                            _this.node = FidjStorageNode.getDemoNode();
                            _this.set(fidjService);
                        };
                        return [4 /*yield*/, fidjService.sync(firstDemoData)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, fidjService.findAll()];
                    case 2:
                        fidjFindAllResults = _a.sent();
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _storage_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./storage.service */ "./src/app/shared/storage.service.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var fidj__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! fidj */ "./node_modules/fidj/fesm5/fidj.js");
/* harmony import */ var _fidj_storage_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./fidj-storage.model */ "./src/app/shared/fidj-storage.model.ts");
...
var Profile = /** @class */ (function () {
    function Profile(storage, fidjService) {
        this.storage = storage;
        this.fidjService = fidjService;
        this.endpoint = null;
        console.log('Profile service');
        this.email = this.storage.get('email') || null;
        this.readyForSync = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](false);
        this.roles = [];
        this.fidjStorage = new _fidj_storage_model__WEBPACK_IMPORTED_MODULE_5__["FidjStorage"]();
    }
    Profile.prototype.refreshProfile = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.fidjStorage.getRefreshedNode(this.fidjService)];
                    case 1:
                        _a.nodeData = _b.sent();
                        this.setRoles(this.fidjService.getRoles());
                        return [4 /*yield*/, this.refreshEndpoint()];
                    case 2:
                        _b.sent();
                        return [2 /*return*/, this.nodeData];
                }
            });
        });
    };
    ...
    Profile.prototype.isLoggedIn = function () {
        return this.fidjService.isLoggedIn();
    };
    Profile.prototype.isReady = function () {
    ...
    Profile.prototype.refreshEndpoint = function () {
        // this.endpoint = null;
        var endpoint = null;
        var endpoints = this.fidjService.getEndpoints();
    ...
    Profile.prototype.storeAll = function () {
        this.fidjStorage.set(this.fidjService);
    };
    Profile = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_storage_service__WEBPACK_IMPORTED_MODULE_2__["Storage"],
            fidj__WEBPACK_IMPORTED_MODULE_4__["FidjService"]])
    ], Profile);
    return Profile;
}());
...
/* harmony import */ var _profile_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./profile.service */ "./src/app/shared/profile.service.ts");
...
var Radar = /** @class */ (function () {
    function Radar(storage, fidjService, profileService, http) {
        this.storage = storage;
        this.fidjService = fidjService;
    ...
    Radar = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_storage_service__WEBPACK_IMPORTED_MODULE_2__["Storage"],
            fidj__WEBPACK_IMPORTED_MODULE_3__["FidjService"],
            _profile_service__WEBPACK_IMPORTED_MODULE_4__["Profile"],
...
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var fidj__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! fidj */ "./node_modules/fidj/fesm5/fidj.js");
/* harmony import */ var _profile_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./profile.service */ "./src/app/shared/profile.service.ts");
/* harmony import */ var _storage_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./storage.service */ "./src/app/shared/storage.service.ts");
/* harmony import */ var _radar_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./radar.service */ "./src/app/shared/radar.service.ts");
    ...
    SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
            ...
            imports: [
                ...
                fidj__WEBPACK_IMPORTED_MODULE_6__["FidjModule"],
            ],
            providers: [
                _profile_service__WEBPACK_IMPORTED_MODULE_7__["Profile"],
                _storage_service__WEBPACK_IMPORTED_MODULE_8__["Storage"],
                _radar_service__WEBPACK_IMPORTED_MODULE_9__["Radar"]
            ],
            exports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"],
...
var Storage = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](Storage, _super);
    function Storage() {
        return _super.call(this, window.localStorage, 'RadarToRain_bot_client.') || this;
    }
    Storage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], Storage);
    return Storage;
}(fidj__WEBPACK_IMPORTED_MODULE_2__["LocalStorage"]));
...
module.exports = __webpack_require__(/*! /home/travis/build/raainio/radartorain/src/main.ts */"./src/main.ts");
